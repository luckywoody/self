...
async function main() {
  ...
  // let mbaiduData = [{keywordname: '长沙微电影拍摄', websiteurl: 'www.hnjingying.cn'}]
  ...
  await baidu.go(1, baiduData)
  log('已完成baidu')
  // await mbaidu.go(1, mbaiduData)
  // log('已完成mbaidu')
  // await sougou.go(2, sougouData)
  // log('已完成sougou')
  // await msougou.go(2, msougouData)
  // log('已完成msougou')
...
function getData(i) {
  let url = `http://api.qunzhikeji.com/api/v1/Task/keywordList.do?platformId=${i}`
...
function postData(data) {
  var options = {
    method: 'POST',
    url: 'http://api.qunzhikeji.com/api/v1/Task/addCostDetail.do',
    headers: {
